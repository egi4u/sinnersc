...
-Secret keys: 
	-TOKEN: 5326259211:AAEjiG6MJCzXdgG9rUnxVnHGBaVG4U-P4sg
	- MODE: prod
	- CHAT_ID_FORWARD: -1001491989174
	- HEROKU_APP_NAME: sinnersc
'''
...
developers = ['1961582245']


addusr = ""
tk = os.getenv("5326259211:AAEjiG6MJCzXdgG9rUnxVnHGBaVG4U-P4sg")
mode = os.getenv("prod")

posting_channel = os.getenv("-1001491989174")
...
if mode == "dev":
	...
	def run(updater):
		...
		HEROKU_APP_NAME = os.environ.get("sinnersc")
		updater.start_webhook(listen="0.0.0.0", port=PORT, url_path=tk)
		updater.bot.set_webhook(f"https://sinnersc.herokuapp.com/"+ tk)
else:
	sys.exit()

@run_async
def start(update):
	update.message.reply_text("This CC Scraper has been started successfully | Developed by Brian- @todayisdisaster")
